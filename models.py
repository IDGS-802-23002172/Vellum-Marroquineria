...
class CierreCaja(db.Model):
    ...
    monto_inicial = db.Column(db.Numeric(14,2), default=0)
    estado = db.Column(db.String(20), default="abierta")
    fecha_apertura = db.Column(db.DateTime, default=datetime.utcnow)
    articulos_vendidos = db.Column(db.Integer, nullable=True)
    total_ventas = db.Column(db.Numeric(14,2), nullable=True)
    utilidad_total = db.Column(db.Numeric(14,2), nullable=True)
